...
export const team: TeamMember[] = [
  {
    id: "1",
    name: "Antoine Leroy",
    role: "Fondateur & Architecte Paysagiste",
    bio: "Diplômé de l'École Nationale Supérieure de Paysage de Versailles, Antoine a fondé Jardins de Prestige en 2009 avec la vision de créer des espaces extérieurs d'exception. Son expertise en design et sa passion pour la botanique guident chaque projet.",
